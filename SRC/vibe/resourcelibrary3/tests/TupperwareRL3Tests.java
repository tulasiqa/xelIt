...
public class TupperwareRL3Tests extends RL3Methods {
	...
	String resourceCategoryId = null;
	 ...
	 /*	String parentCategory_text = "PCAT_582"; 
	  String multipleResourceTitle_text ="Business Multiple230"; 
	  String resourceAssetPDF = "PDF Asset 376";
	 */
	@Test(priority = 11500)
...
//	@Test(priority=11517)
	public void AccessNextResourceFromWorkspace() throws Exception{
		...
		boolean isResPre  = verifyResourcePresentUserSide(multipleResourceTitle_text);
		if(isResPre) {
		...
		if (!isResPre) {
			logInfo(multipleResourceTitle_text + " is not found");
			Assert.assertFalse(isResPre, multipleResourceTitle_text + " is not found");
		}
