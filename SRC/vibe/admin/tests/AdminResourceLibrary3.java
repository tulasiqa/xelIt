...
@Priority(15)
public class AdminResourceLibrary3 extends RL3Methods {
	...
	//	String resourceId = getResourceId(); prop.setLocatorForEnvironment(appUrl, "resId", resourceId);	 
	...
	public void RL_Settings_AbilityToViewNewestResources() throws Exception {
		...
		navigate2UserRL();
		waitOnSpinner();
		boolean isCategoryFound = verifyAResourceCategoryUserSide("Newest Resources");
		if (isCategoryFound) {
			selectAResourceCategoryUserSide("Newest Resources");
