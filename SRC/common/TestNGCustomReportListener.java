...
public class TestNGCustomReportListener implements IReporter{
	...
	private String reportTitle= "Full Suite Report";
	...
	protected void startHtml(PrintWriter out) {
		...
		out.println(".passedodd td {color: #0A0}");
		out.println(".passedeven td {color: #0A0}");
		out.println(".skippedodd td {color: #CCC}");
		out.println(".skippedodd td {color: #DDD}");
		out.println(".failedodd td,.numi_attn {color: #D00}");
		out.println(".failedeven td,.stripe .numi_attn {color: #D00}");
